            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="order-1 lg:order-2 grid grid-cols-2 gap-4">
                    <div className="bg-neutral-900 aspect-[3/4] rounded-sm overflow-hidden relative">
                        <img src="/images/story-origin.png" alt="Origin" className="absolute inset-0 w-full h-full object-cover opacity-80" />
                    </div>
                    <div className="bg-neutral-800 aspect-[3/4] rounded-sm overflow-hidden relative mt-12">
                        <img src="/images/story-roasting.png" alt="Process" className="absolute inset-0 w-full h-full object-cover opacity-80" />
                    </div>
                </div>
            </div>
        </section>
